            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <BreezeNavLink :href="route('marks.index')" :active="route().current('marks.index')">
                                    Marks
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('form.upgradeStudentsOfGrade')" :active="route().current('form.upgradeStudentsOfGrade')">
                                    Upgrade Students
                                </BreezeNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <BreezeResponsiveNavLink :href="route('students.index')" :active="route().current('students.index')">
                            Students
                        </BreezeResponsiveNavLink>
                        <BreezeResponsiveNavLink :href="route('exams.index')" :active="route().current('exams.index')">
                            Exams
                        </BreezeResponsiveNavLink>
                    </div>
